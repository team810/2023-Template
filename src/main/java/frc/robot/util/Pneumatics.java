...
public class Pneumatics extends SubsystemBase {
    ...
    private final CTREPCMSim ctrePneumaticsControlModuleSim;
        ...
        switch (pneumaticsModuleType)
        {
            case CTREPCM:
                ...
                if (Robot.isSimulation()){
                    ctrePneumaticsControlModuleSim = new CTREPCMSim(ctrePneumaticsControlModule);} else {
                    ctrePneumaticsControlModuleSim = null;}
        ...
        switch (pneumaticsModuleType)
        {
            case CTREPCM:
                if (Robot.isReal())
                {
                    ...
                    Logger.getInstance().recordOutput("Pneumatics/CompressorOn", ctrePneumaticsControlModuleSim.getCompressorOn());
                    Logger.getInstance().recordOutput("Pneumatics/CompressorCurrent", ctrePneumaticsControlModuleSim.getCompressorCurrent());
